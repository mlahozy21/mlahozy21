...
- **[Churn Prediction (MLOps)](https://github.com/mlahozy21/Churn-Prediction-MLOps)** — an end-to-end production-style pipeline: scikit-learn model, FastAPI serving, Docker, CI and permutation-based explainability (real Telco data