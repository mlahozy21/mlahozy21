...
- **[GPT from Scratch](https://github.com/mlahozy21/GPT-from-Scratch)** — a modern decoder-only Transformer (RoPE, RMSNorm, SwiGLU, KV-cache) implemented and trained from scratch in PyTorch, validated on a copy task and with a scaling study.
